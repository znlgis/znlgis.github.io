...
| Spring Cloud | 2021.0.9 | 微服务框�?|
| Spring Cloud Alibaba | 2021.0.6.1 | 阿里云微服务套件 |
| Nacos | 2.x | 注册中心、配置中�?|
| Sentinel | 1.8.x | 流量控制、熔断降�?|
| Seata | 1.6.x | 分布式事�?|
...
- 升级Spring Boot�?.7.18版本
- 升级Spring Framework�?.3.39版本
- 升级Logback�?.2.13版本
- 升级Tomcat�?.0.112版本
- 优化安全配置，修复已知漏�?
- 增强系统稳定性和性能
...
| RuoYi-Vue | 前后端分离版�?| Spring Boot + Vue |
| RuoYi-Cloud | 微服务版�?| Spring Cloud Alibaba + Vue |
| RuoYi-Cloud-Vue3 | 微服务Vue3版本 | Spring Cloud Alibaba + Vue3 + Vite |
| RuoYi-App | 移动端版�?| uni-app |
...
[返回目录](./index) | [下一章：系统架构详解](./�?2�?系统架构详解)
