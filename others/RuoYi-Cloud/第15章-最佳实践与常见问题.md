...
| 类型 | 规范 | 示例 |
|------|------|------|
| 类名 | 大驼�?| SysUserController |
| 方法�?| 小驼�?| getUserInfo |
| 变量�?| 小驼�?| userName |
| 常量�?| 全大写下划线 | MAX_PAGE_SIZE |
| 包名 | 全小�?| com.ruoyi.system |
| 数据库表�?| 小写下划�?| sys_user |
| 数据库字�?| 小写下划�?| user_name |
...
1. **代码规范**：命名规范、Controller/Service层规�?
2. **安全规范**：SQL注入、XSS防护、敏感数据处�?
3. **性能优化**：数据库优化、缓存优化、接口优�?
4. **常见问题**：启动、认证、权限、前端、部署问�?
5. **版本升级**：升级步骤和注意事项
...
[上一章：二次开发指南](./�?4�?二次开发指�?md) | [返回目录](./index)
