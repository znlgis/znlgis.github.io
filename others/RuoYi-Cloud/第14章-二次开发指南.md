  ...
  <div class="app-container">
    ...
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch">
      <el-form-item label="名称" prop="name">
        <el-input v-model="queryParams.name" placeholder="请输入名�? clearable @keyup.enter="handleQuery" />
      </el-form-item>
...
1. **创建新模�?*：Maven模块、启动类、配置文�?
2. **业务开�?*：实体类、Mapper、Service、Controller
3. **前端开�?*：API接口、Vue页面
4. **权限配置**：菜单和按钮权限SQL
...
[上一章：Docker容器化部署](./�?3�?Docker容器化部�?md) | [返回目录](./index) | [下一章：最佳实践与常见问题](./�?5�?最佳实践与常见问题)
