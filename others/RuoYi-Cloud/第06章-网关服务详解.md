...
### 6.3.5 请求缓存过滤�?CacheRequestFilter
...
1. **网关职责**：路由转发、负载均衡、安全认�?
2. **路由配置**：谓词、过滤器的使�?
3. **过滤�?*：认证、验证码、XSS、黑名单过滤�?
...
[上一章：认证与授权中心](./�?5�?认证与授权中�?md) | [返回目录](./index) | [下一章：系统管理模块](./�?7�?系统管理模块)
