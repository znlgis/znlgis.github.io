...
```
┌─────────────────────────────────────────────────────────────────────────────�?
�?                       Spring Cloud Alibaba 生�?                           �?
├─────────────────────────────────────────────────────────────────────────────�?
�?                                                                            �?
�? ┌─────────────�? ┌─────────────�? ┌─────────────�? ┌─────────────�?       �?
�? �?  Nacos     �? �? Sentinel   �? �?   Seata    �? �?  Dubbo     �?       �?
�? �?服务发现/   �? �?  流量控制   �? �? 分布式事�? �? �?  RPC框架   �?       �?
�? �?配置管理    �? �?  熔断降级   �? �?            �? �? (可�?     �?       �?
�? └─────────────�? └─────────────�? └─────────────�? └─────────────�?       �?
�?                                                                            �?
├─────────────────────────────────────────────────────────────────────────────�?
...
1. **微服务架构理�?*：了解微服务的优势和挑战
2. **技术栈选型**：掌握Spring Cloud Alibaba生态组�?
3. **核心模块设计**：理解各模块的职责和依赖关系
4. **网关架构**：了解Gateway的过滤器机制和路由配�?
5. **认证授权**：掌握Token机制和权限校验流�?
...
[上一章：RuoYi-Cloud概述与入门](./�?1�?RuoYi-Cloud概述与入�?md) | [返回目录](./index) | [下一章：环境准备与安装部署](./�?3�?环境准备与安装部�?md)
