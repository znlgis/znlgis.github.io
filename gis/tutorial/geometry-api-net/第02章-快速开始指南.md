...
```bash
# 进入示例项目目录
cd samples/OpenGIS.Esri.Geometry.Samples
...
<ItemGroup>
    <ProjectReference Include="../path/to/OpenGIS.Esri.Geometry.Core/OpenGIS.Esri.Geometry.Core.csproj" />
</ItemGroup>
```
...
3. 查看 `samples/OpenGIS.Esri.Geometry.Samples` 目录中的更多示例
4. 运行测试用例，了解各功能的预期行为
...
<div style="display: flex; justify-content: space-between; margin: 20px 0;">
  <a href="https://znlgis.github.io/gis/tutorial/geometry-api-net/第01章-项目概述与框架理念/" style="text-decoration: none;">← 上一章</a>
  <a href="https://znlgis.github.io/gis/tutorial/geometry-api-net/" style="text-decoration: none;">目录</a>
  <a href="https://znlgis.github.io/gis/tutorial/geometry-api-net/第03章-核心几何类型详解/" style="text-decoration: none;">下一章 →</a>
</div>
