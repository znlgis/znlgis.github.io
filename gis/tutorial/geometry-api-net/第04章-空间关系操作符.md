                     ...
                     SpatialReference? spatialRef = null)
{
    ...
    // 其余几何类型：交由稳健关系引擎计算真正的最小平面距离
    // （逐对顶点/线段求最近点，非包络近似；相交含包含/相接返回 0，空几何返回 NaN）
    return RelateOps.DistanceGeom(geometry1, geometry2);
}
```

> 上述 `Point/Envelope` 分支只是便于理解的手算示例。`DistanceOperator` 的实际实现把任意几何对统一委托给内部 `RelateOps.DistanceGeom`，对点—线、线—线、面—面等都计算精确的最小平面距离，并已对 OGC-SF 语料与 PostGIS 逐条验证。
...
<div style="display: flex; justify-content: space-between; margin: 20px 0;">
  <a href="https://znlgis.github.io/gis/tutorial/geometry-api-net/第03章-核心几何类型详解/" style="text-decoration: none;">← 上一章</a>
  <a href="https://znlgis.github.io/gis/tutorial/geometry-api-net/" style="text-decoration: none;">目录</a>
  <a href="https://znlgis.github.io/gis/tutorial/geometry-api-net/第05章-几何运算操作符/" style="text-decoration: none;">下一章 →</a>
</div>
