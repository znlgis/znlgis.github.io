...
for (OguFeature feature : layer.getFeatures()) {
    ...
    for (OguCoordinate coord : coords) {
        System.out.printf("点号: %s, X: %.3f, Y: %.3f%n",
            coord.getPointNumber(), coord.getX(), coord.getY());
    }
}
```
...
public class SafeConverter {
    ...
    public static boolean safeConvert(String input, String output,
        ...
        // 3. 选择引擎：AUTO表示由GisEngineFactory按格式与可用性自动选择（GDAL优先，否则GeoTools）
        GisEngineType readEngine = GisEngineType.AUTO;
        GisEngineType writeEngine = GisEngineType.AUTO;
        
        // 4. 检查引擎可用性（FileGDB只能用GDAL，缺少本地库时读取会抛EngineNotSupportedException）
        if (!Boolean.TRUE.equals(OgrUtil.getOgrInitSuccess())
                && (inputFormat == DataFormatType.FILEGDB || outputFormat == DataFormatType.FILEGDB)) {
            System.err.println("FileGDB格式需要GDAL引擎，但GDAL本地库不可用");
            return false;
        }
...
[← 上一章：双引擎架构设计](https://znlgis.github.io/gis/tutorial/opengis-utils-for-java/第05章-双引擎架构设计/) | [下一章：几何处理与空间分析 →](https://znlgis.github.io/gis/tutorial/opengis-utils-for-java/第07章-几何处理与空间分析/)
...
<div style="display: flex; justify-content: space-between; margin: 20px 0;">
  <a href="https://znlgis.github.io/gis/tutorial/opengis-utils-for-java/第05章-双引擎架构设计/" style="text-decoration: none;">← 上一章</a>
  <a href="https://znlgis.github.io/gis/tutorial/opengis-utils-for-java/" style="text-decoration: none;">目录</a>
  <a href="https://znlgis.github.io/gis/tutorial/opengis-utils-for-java/第07章-几何处理与空间分析/" style="text-decoration: none;">下一章 →</a>
</div>
