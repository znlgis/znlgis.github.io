        ...
        for (OguFeature feature : layer.getFeatures()) {
            ...
            if (result.isValid()) {
                ...
                System.out.printf("FID %s: %s%n", 
                    feature.getId(), result.getErrorType().getDesc());
                
                try {
                    Geometry fixedGeom = GeometryUtil.validate(geom);
                    feature.setGeometry(GeometryUtil.geometry2Wkt(fixedGeom));
                    fixed++;
                } catch (Exception e) {
...
public class BufferAnalysis {
    ...
    public static OguLayer createBufferLayer(OguLayer inputLayer, 
        ...
        for (OguFeature inputFeature : inputLayer.getFeatures()) {
            Geometry geom = GeometryUtil.wkt2Geometry(inputFeature.getGeometry());
            Geometry buffer = GeometryUtil.buffer(geom, distance);
            
            OguFeature bufferFeature = new OguFeature();
            bufferFeature.setId(inputFeature.getId());
            bufferFeature.setGeometry(GeometryUtil.geometry2Wkt(buffer));
...
[← 上一章：数据格式转换实战](https://znlgis.github.io/gis/tutorial/opengis-utils-for-java/第06章-数据格式转换实战/) | [下一章：坐标系管理与转换 →](https://znlgis.github.io/gis/tutorial/opengis-utils-for-java/第08章-坐标系管理与转换/)
...
<div style="display: flex; justify-content: space-between; margin: 20px 0;">
  <a href="https://znlgis.github.io/gis/tutorial/opengis-utils-for-java/第06章-数据格式转换实战/" style="text-decoration: none;">← 上一章</a>
  <a href="https://znlgis.github.io/gis/tutorial/opengis-utils-for-java/" style="text-decoration: none;">目录</a>
  <a href="https://znlgis.github.io/gis/tutorial/opengis-utils-for-java/第08章-坐标系管理与转换/" style="text-decoration: none;">下一章 →</a>
</div>
