...
feature.setId("1");
feature.setGeometry("POINT(116 39)");  // 点，但图层是面
...
public class FailFastPattern {
    ...
    public OguLayer readLayer(DataFormatType format, String path,
        ...
        // 引擎检查（显式请求GDAL而本地库不可用时，工厂抛EngineNotSupportedException）
        GisEngine engineInstance = GisEngineFactory.getEngine(engine);
        if (!engineInstance.supports(format)) {
            throw new EngineNotSupportedException(
                "引擎不可用或不支持格式: " + engineInstance.getName() + " - " + format);
        }
...
[← 上一章：坐标系管理与转换](https://znlgis.github.io/gis/tutorial/opengis-utils-for-java/第08章-坐标系管理与转换/) | [下一章：实用工具类详解 →](https://znlgis.github.io/gis/tutorial/opengis-utils-for-java/第10章-实用工具类详解/)
...
<div style="display: flex; justify-content: space-between; margin: 20px 0;">
  <a href="https://znlgis.github.io/gis/tutorial/opengis-utils-for-java/第08章-坐标系管理与转换/" style="text-decoration: none;">← 上一章</a>
  <a href="https://znlgis.github.io/gis/tutorial/opengis-utils-for-java/" style="text-decoration: none;">目录</a>
  <a href="https://znlgis.github.io/gis/tutorial/opengis-utils-for-java/第10章-实用工具类详解/" style="text-decoration: none;">下一章 →</a>
</div>
