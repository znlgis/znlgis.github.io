...
public class GeoToolsLayerReader implements LayerReader {
    ...
    private OguLayer readPostGIS(String connStr, String layerName,
        ...
        try {
            ...
            params.put("passwd", connModel.getPasswd());
    ...
    private OguLayer convertToOguLayer(SimpleFeatureCollection collection,
        ...
        for (AttributeDescriptor attr : schema.getAttributeDescriptors()) {
            if (!(attr instanceof GeometryDescriptor)) {
                ...
                field.setDataType(FieldDataType.fieldDataTypeByTypeClass(
    ...
    private OguFeature convertFeature(SimpleFeature sf, int fid) {
        ...
        feature.setId(String.valueOf(fid));
        
        // 转换几何
        Geometry geom = (Geometry) sf.getDefaultGeometry();
        if (geom != null) {
            feature.setGeometry(geom.toText());
        }
    ...
    private void writeShapefile(OguLayer layer, String path) {
        try {
            ...
            for (OguFeature oguFeature : layer.getFeatures()) {
                // 设置几何
                Geometry geom = GeometryUtil.wkt2Geometry(oguFeature.getGeometry());
                ...
                SimpleFeature feature = featureBuilder.buildFeature(oguFeature.getId());
...
public class GdalLayerReader implements LayerReader {
    ...
    private OguFeature convertFeature(Feature ogrFeature, FeatureDefn defn) {
        OguFeature feature = new OguFeature();
        feature.setId(String.valueOf(ogrFeature.GetFID()));
...
public class GdalLayerWriter implements LayerWriter {
    ...
    private DataSource writeFileGDB(Driver driver, OguLayer layer,
        ...
        for (OguFeature oguFeature : layer.getFeatures()) {
            ...
            // 设置几何
            if (oguFeature.getGeometry() != null) {
                Geometry geom = Geometry.CreateFromWkt(oguFeature.getGeometry());
...
<div style="display: flex; justify-content: space-between; margin: 20px 0;">
  <a href="https://znlgis.github.io/gis/tutorial/opengis-utils-for-java/第04章-统一图层模型详解/" style="text-decoration: none;">← 上一章</a>
  <a href="https://znlgis.github.io/gis/tutorial/opengis-utils-for-java/" style="text-decoration: none;">目录</a>
  <a href="https://znlgis.github.io/gis/tutorial/opengis-utils-for-java/第06章-数据格式转换实战/" style="text-decoration: none;">下一章 →</a>
</div>
