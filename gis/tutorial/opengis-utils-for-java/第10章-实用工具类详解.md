...
public class FeatureSorter {
    ...
    public static void sortByFid(List<OguFeature> features) {
        features.sort((f1, f2) -> SortUtil.compareString(f1.getId(), f2.getId()));
    }
}
...
<div style="display: flex; justify-content: space-between; margin: 20px 0;">
  <a href="https://znlgis.github.io/gis/tutorial/opengis-utils-for-java/第09章-异常处理体系/" style="text-decoration: none;">← 上一章</a>
  <a href="https://znlgis.github.io/gis/tutorial/opengis-utils-for-java/" style="text-decoration: none;">目录</a>
  <a href="https://znlgis.github.io/gis/tutorial/opengis-utils-for-java/第11章-开发实战案例/" style="text-decoration: none;">下一章 →</a>
</div>
