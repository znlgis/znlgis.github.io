...
RuntimeException
    └── LayerValidationException (图层验证异常，直接继承RuntimeException，不继承OguException)
```
...
| GDAL | 3.13.0 | GDAL引擎（可选） |
| Hutool | 5.8.47 | Java工具库 |
| Fastjson2 | 2.0.64 | JSON处理 |
| Zip4j | 2.11.6 | ZIP处理 |
| Jackson-core | 2.22.2 | JSON底层库 |
| Lombok | 1.18.46 | 代码简化 |
...
[下一章：快速入门与环境配置 →](https://znlgis.github.io/gis/tutorial/opengis-utils-for-java/第02章-快速入门与环境配置/)
...
<div style="display: flex; justify-content: space-between; margin: 20px 0;">
  ...
  <a href="https://znlgis.github.io/gis/tutorial/opengis-utils-for-java/第02章-快速入门与环境配置/" style="text-decoration: none;">下一章 →</a>
</div>
