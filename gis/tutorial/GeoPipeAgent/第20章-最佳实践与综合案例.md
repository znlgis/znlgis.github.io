  ...
  steps:
    ...
    - id: filter-main-roads
      ...
      params:
        ...
        expression: "road_class in ['primary', 'secondary']"
...
**导航**：[← 第十九章：Cookbook 示例精讲](https://znlgis.github.io/gis/tutorial/GeoPipeAgent/第19章-Cookbook示例精讲/) ｜ [返回教程目录 →](https://znlgis.github.io/gis/tutorial/GeoPipeAgent/)
