...
```bash
# 1. 更新镜像版本
sed -i 's/TAG=3.0.0.0/TAG=3.0.1.0/' .env
...
```bash
# 1. 恢复版本号
sed -i 's/TAG=3.0.1.0/TAG=3.0.0.0/' .env
...
<div style="display: flex; justify-content: space-between; margin: 20px 0;">
  <a href="https://znlgis.github.io/gis/tutorial/geoserver-cloud/第08章-运维监控与故障排除/第07章-Kubernetes部署实战/" style="text-decoration: none;">← 上一章</a>
  <a href="https://znlgis.github.io/gis/tutorial/geoserver-cloud/第08章-运维监控与故障排除/" style="text-decoration: none;">目录</a>
  <a href="https://znlgis.github.io/gis/tutorial/geoserver-cloud/第08章-运维监控与故障排除/第09章-开发扩展与定制/" style="text-decoration: none;">下一章 →</a>
</div>
