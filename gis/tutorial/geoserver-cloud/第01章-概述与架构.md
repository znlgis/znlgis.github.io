...
截至本文档编写时，GeoServer Cloud 的最新版本为 **v3.0.1.1**，基于 GeoServer **3.0.1** 版本。

版本号格式说明：
- 前三位（3.0.1）对应 GeoServer 版本
- 最后一位（1）是 GeoServer Cloud 的补丁版本
...
<div style="display: flex; justify-content: space-between; margin: 20px 0;">
  ...
  <a href="https://znlgis.github.io/gis/tutorial/geoserver-cloud/第02章-环境准备与安装部署/" style="text-decoration: none;">下一章 →</a>
</div>
