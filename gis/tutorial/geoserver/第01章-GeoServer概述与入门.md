...
- **2026年**：GeoServer 3.0.1 发布，基于 Spring Framework 7、Jakarta EE、Java 17/21，重新设计管理界面（支持暗色模式），升级至 Tomcat 11；配套 GeoTools 35.1、GeoWebCache 2.0.1
...
<div style="display: flex; justify-content: space-between; margin: 20px 0;">
  ...
  <a href="https://znlgis.github.io/gis/tutorial/geoserver/第02章-GeoServer安装与配置/" style="text-decoration: none;">下一章 →</a>
</div>
