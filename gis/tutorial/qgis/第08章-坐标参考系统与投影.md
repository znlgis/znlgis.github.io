...
**上一章**：[第07章 栅格数据处理](../第07章-栅格数据处理)

**下一章**：[第09章 地图样式与符号化](../第09章-地图样式与符号化)
...
<div style="display: flex; justify-content: space-between; margin: 20px 0;">
  <a href="第07章-栅格数据处理" style="text-decoration: none;">← 上一章</a>
  <a href="./" style="text-decoration: none;">目录</a>
  <a href="第09章-地图样式与符号化" style="text-decoration: none;">下一章 →</a>
</div>
