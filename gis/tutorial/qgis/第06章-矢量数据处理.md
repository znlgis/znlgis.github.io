...
**上一章**：[第05章 数据源管理与加载](第05章-数据源管理与加载)

**下一章**：[第07章 栅格数据处理](第07章-栅格数据处理)
...
<div style="display: flex; justify-content: space-between; margin: 20px 0;">
  <a href="第05章-数据源管理与加载" style="text-decoration: none;">← 上一章</a>
  <a href="./" style="text-decoration: none;">目录</a>
  <a href="第07章-栅格数据处理" style="text-decoration: none;">下一章 →</a>
</div>
