...
**相关资源**：
- [GeoTools 用户指南](https://docs.geotools.org/latest/userguide/)
- [GeoServer 集成指南](https://docs.geoserver.org/stable/en/user/)
...
<div style="display: flex; justify-content: space-between; margin: 20px 0;">
  <a href="https://znlgis.github.io/gis/tutorial/geotools/第16章-GeoServer集成开发/" style="text-decoration: none;">← 上一章</a>
