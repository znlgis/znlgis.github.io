...
SharpMap 项目最初由 Morten Nielsen 创建，自 2004 年开始开发。该项目托管在 GitHub 上，但近年来维护活动已大幅减少，最新稳定版本停留在 1.2.0（2021 年 3 月）。
...
- **当前版本**：1.2.0（发布于 2021 年 3 月，项目目前基本停止维护）

> **注意**：SharpMap 项目已基本处于非活跃维护状态，最新版本仍为 1.2.0（2021 年 3 月发布）。对于新项目，建议考虑使用活跃维护的替代方案，如 Mapsui 或 NetTopologySuite。如确需使用 SharpMap，请注意可能存在兼容性和安全更新方面的风险。
...
<div style="display: flex; justify-content: space-between; margin: 20px 0;">
  ...
  <a href="https://znlgis.github.io/gis/tutorial/SharpMap/第02章-环境配置与项目创建/" style="text-decoration: none;">下一章 →</a>
</div>
