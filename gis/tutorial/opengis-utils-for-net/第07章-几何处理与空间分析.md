...
// GeoJSON → WKT（支持裸几何 / Feature / FeatureCollection，集合取第一个要素的几何）
string geojson = "{ \"type\": \"Point\", \"coordinates\": [ 116.404, 39.915 ] }";
string wktBack = GeometryUtil.Geojson2Wkt(geojson);
Console.WriteLine(wktBack);  // POINT (116.404 39.915)

// GeoJSON → Geometry（返回 OGR Geometry，调用方负责释放）
var geomFromJson = GeometryUtil.Geojson2Geometry(geojson);

// 说明：内部经由临时文件走 GDAL GeoJSON 驱动解析；
// 无法解析或不含几何的输入抛出 ArgumentException；
...
<div style="display: flex; justify-content: space-between; margin: 20px 0;">
  <a href="https://znlgis.github.io/gis/tutorial/opengis-utils-for-net/第06章-数据格式转换实战/" style="text-decoration: none;">← 上一章</a>
  <a href="https://znlgis.github.io/gis/tutorial/opengis-utils-for-net/" style="text-decoration: none;">目录</a>
  <a href="https://znlgis.github.io/gis/tutorial/opengis-utils-for-net/第08章-坐标系管理与转换/" style="text-decoration: none;">下一章 →</a>
</div>
