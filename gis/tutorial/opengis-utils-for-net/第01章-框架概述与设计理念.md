...
1. **CGCS2000坐标系支持**
   - CRS 类型识别与元数据由 GDAL/PROJ 数据库提供，覆盖全球 EPSG 坐标系
   - 保留 CGCS2000 3度带/6度带专用辅助方法（带号计算与 EPSG 带号码互推，经 PROJ 核实：3度带 25-45 带 ↔ EPSG:4513-4533、6度带 13-23 带 ↔ EPSG:4491-4501）
   - 支持显式中转转换（TransformThrough）与转换路径建议（GetTransformRecommendation）
...
| 包名 | 版本 | 用途 |
|-----|------|------|
| MaxRev.Gdal.Core | 3.13.3.557 | GDAL/OGR核心绑定 |
| MaxRev.Gdal.Universal | 3.13.3.557 | 跨平台GDAL运行时 |
| System.Text.Json | 10.0.11 | JSON序列化 |
| System.Text.Encoding.CodePages | 10.0.11 | 编码支持（GBK等） |
...
<div style="display: flex; justify-content: space-between; margin: 20px 0;">
  ...
  <a href="https://znlgis.github.io/gis/tutorial/opengis-utils-for-net/第02章-快速入门与环境配置/" style="text-decoration: none;">下一章 →</a>
</div>
