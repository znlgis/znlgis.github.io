...
<Project Sdk="Microsoft.NET.Sdk">
  ...
  <ItemGroup>
    <PackageReference Include="OpenGIS.Utils" Version="1.0.8" />
  </ItemGroup>
</Project>
```
...
| 依赖包 | 版本 | 用途 |
|-------|------|------|
| MaxRev.Gdal.Core | 3.13.3.557 | GDAL核心绑定 |
| MaxRev.Gdal.Universal | 3.13.3.557 | 跨平台GDAL运行时 |
| System.Text.Json | 10.0.11 | JSON处理 |
| System.Text.Encoding.CodePages | 10.0.11 | 编码支持 |
| SharpZipLib | 1.4.2 | ZIP压缩 |
| Microsoft.Extensions.Logging.Abstractions | 10.0.11 | 日志抽象（OguLogging 门面） |
| System.Memory | 4.6.3 | 内存与性能 |
| System.Buffers | 4.6.1 | 缓冲区支持 |
...
> 仓库 `samples/OpenGIS.Utils.Samples` 项目提供覆盖全部 API 的可运行示例（图层模型、几何、文件读写、追加与 FID、TXT、CRS、异常、工具类、GDAL 配置、PostGIS 共 10 个样例），可 `dotnet run` 直接对照学习。
...
{
    // GDAL 3.6+ 起 OpenFileGDB 支持写入，OGU4Net 写 .gdb 时默认使用该驱动
    Console.WriteLine("OpenFileGDB driver is available (read/write since GDAL 3.6)");
}
else
{
...
<div style="display: flex; justify-content: space-between; margin: 20px 0;">
  <a href="https://znlgis.github.io/gis/tutorial/opengis-utils-for-net/第01章-框架概述与设计理念/" style="text-decoration: none;">← 上一章</a>
  <a href="https://znlgis.github.io/gis/tutorial/opengis-utils-for-net/" style="text-decoration: none;">目录</a>
  <a href="https://znlgis.github.io/gis/tutorial/opengis-utils-for-net/第03章-核心架构解析/" style="text-decoration: none;">下一章 →</a>
</div>
