...
> **版本提示**：`IsGeographicCRS`、`GetCrsInfo`、`TransformThrough`、`GetTransformRecommendation` 为较新版本新增的 API。`IsProjectedCRS`、`IsGeographicCRS`、`GetTolerance` 通过 GDAL/PROJ 数据库识别坐标系，覆盖港澳台及国际 EPSG 坐标系；`GetDh` 系列仍为中国分带专用。
