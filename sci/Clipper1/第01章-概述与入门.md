...
5. **核心类**：`Clipper`（裁剪）、`ClipperOffset`（偏移）、`PolyTree`（结果组织）

在后续章节中，我们将深入分析每个核心数据结构和算法实现的细节。

---

[返回目录](https://znlgis.github.io/sci/Clipper1/) | [下一章：核心数据结构](https://znlgis.github.io/sci/Clipper1/第02章-核心数据结构/)
