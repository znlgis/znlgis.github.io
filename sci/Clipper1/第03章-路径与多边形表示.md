---
layout: default
title: 第3章：路径与多边形表示 - Path、Paths、PolyNode、PolyTree
---
...
[上一章：核心数据结构](https://znlgis.github.io/sci/Clipper1/第02章-核心数据结构/) | [返回目录](https://znlgis.github.io/sci/Clipper1/) | [下一章：枚举类型与常量](https://znlgis.github.io/sci/Clipper1/第04章-枚举类型与常量/)
