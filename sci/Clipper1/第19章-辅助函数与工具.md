...
## 19.9 DistanceSqrd �?DistanceFromLineSqrd
...
本章介绍�?Clipper 库的辅助函数和工具方法：

1. **简化函�?*：SimplifyPolygon 消除自相�?
2. **清理函数**：CleanPolygon 移除冗余顶点
3. **闵可夫斯基运�?*：MinkowskiSum/MinkowskiDiff
...
[上一章：偏移算法实现](�?8�?偏移算法实现) | [返回目录](../index) | [下一章：实际应用与最佳实践](�?0�?实际应用与最佳实�?
