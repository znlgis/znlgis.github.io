---
layout: default
title: 第3章：路径与多边形表示 - Path64、PathD、Paths64、PathsD
---
...
1. **继承 List<Point64>**：直接获得所有列表操作方法
...
[上一章：核心数据结构](https://znlgis.github.io/sci/Clipper2/第02章-核心数据结构/) | [返回目录](https://znlgis.github.io/sci/Clipper2/) | [下一章：矩形边界](https://znlgis.github.io/sci/Clipper2/第04章-矩形边界/)
