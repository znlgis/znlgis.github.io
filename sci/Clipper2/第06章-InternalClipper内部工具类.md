---
layout: default
title: �?章：InternalClipper 内部工具�?
---

# �?章：InternalClipper 内部工具�?

## 6.1 概述

`InternalClipper` �?Clipper2 的核心工具类，包含了大量的数学计算和几何判断方法。这些方法主要用于内部算法实现，但部分方法也可供外部使用�?
...
**几何意义**�?
- 返回�?> 0：pt3 在向�?pt1→pt2 的左�?
- 返回�?< 0：pt3 在向�?pt1→pt2 的右�?
- 返回�?= 0：三点共�?
...
这个方法使用 128 位整数避免溢出，只返回符号（-1�?�?）而非精确值�?
...
这些方法的高效和正确实现�?Clipper2 稳定运行的基础�?

---

[上一章：枚举类型与常量](�?5�?枚举类型与常�? | [返回目录](../index) | [下一章：高精度运算](�?7�?高精度运�?
