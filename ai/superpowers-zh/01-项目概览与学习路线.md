...
从 README 和 package.json 可以看出，superpowers-zh 当前以 npm 包形式发布，包名为 `superpowers-zh`，版本为 `1.7.13`，要求 Node.js `>=20.0.0`。它包含 `skills/`、`agents/`、`commands/`、`hooks/`、各类工具安装文档以及一键安装脚本 `bin/superpowers-zh.js`。
...
2. **工具覆盖扩大。** 通过一键安装脚本适配 Claude Code、Copilot CLI、Hermes Agent、Cursor、Windsurf、Kiro、Gemini CLI、Codex、Aider、Trae、VS Code Copilot、DeerFlow、OpenCode、OpenClaw、Qwen Code、Antigravity、Claw Code、Qoder、Crush、Reasonix、ZCode、DeepSeek Harness、Kimi Code、Cline、Kilo Code、CodeBuddy、CodeArts 等 26 个工具。
3. **本土化 Skills。** 新增 4 个中国原创 Skill：中文代码审查、中文 Git 工作流、中文技术文档、中文提交规范。
