...
从 README 和 package.json 可以看出，superpowers-zh 当前以 npm 包形式发布，包名为 `superpowers-zh`，版本为 `1.6.0`，要求 Node.js `>=20.0.0`。它包含 `skills/`、`agents/`、`commands/`、`hooks/`、各类工具安装文档以及一键安装脚本 `bin/superpowers-zh.js`。
