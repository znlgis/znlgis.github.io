...
- **[qgis](https://znlgis.github.io/gis/qgis/SKILL.md)** — QGIS Python API (PyQGIS) 和 Processing 框架 — 详见 `gis/qgis/SKILL.md`
...
...
OpenGIS-Skills 的 GIS 分类当前有 24 个技能，覆盖了最核心的数据处理（GDAL、PostGIS、GeoPandas）、Web 服务（GeoServer、QGIS Server基础的但提升不足）、前端可视化（CesiumJS、OpenLayers、MapLibre）等方向，但仍有大量重要的开源 GIS 工具未被覆盖。
