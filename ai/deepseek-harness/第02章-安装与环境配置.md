...
> **写作时点声明**：本文写作于 2026 年 8 月，对应仓库版本 `0.1.5-rc.2`。安装命令与版本号均以 [docs/development.md](https://github.com/deepseek-ai/deepseek-harness/blob/master/docs/development.md) 与根 `package.json` 的 `master` 原文核对；项目处于 developer preview，命令可能随上游迭代变化。
