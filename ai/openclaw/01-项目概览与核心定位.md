...
仓库中重要内容包括：`README.md` 项目总览，`docs/` 官方文档，`package.json` npm 包定义，`openclaw.mjs` CLI 入口，`extensions/` 插件与通道扩展，`apps/` 伴随应用，`skills/` 内置技能，`Dockerfile` 与 `docker-compose.yml` 容器部署资源。
