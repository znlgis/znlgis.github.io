...
> **下一章**：[第三章：模型配置详解](https://znlgis.github.io/ai/my-opencode-deepseek-config/03-模型配置详解/) —— 深入讲解 DeepSeek V4 Pro 与 Flash 的模型分工原则、Provider 配置细节、thinking mode 启用方式以及 Subagent 的模型分配逻辑。
