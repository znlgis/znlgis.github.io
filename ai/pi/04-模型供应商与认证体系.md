...
下一章：[第五章：配置体系全解](https://znlgis.github.io/ai/pi/04-模型供应商与认证体系/05-配置体系全解/) 将深入 Pi 的配置体系全解——包括 `~/.pi/agent/settings.json` 的每一个配置项、Prompt Templates、Themes 主题系统，以及如何通过配置文件精确控制 Agent 的行为。
