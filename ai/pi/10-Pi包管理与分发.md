...
第一章提到 Pi 有 **4600+ 社区包**——这不是夸张的数字，而是截至 2026 年 9 月 npm 上以 `pi-` 开头的包的实际统计。Pi 包生态之所以如此繁荣，根本原因在于 Mario 把包定义得极其简单：**一个 Pi 包就是一个普通的 npm 包或 Git 仓库，其中声明了 Pi 应当从中加载哪些资源**。
