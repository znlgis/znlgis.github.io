...
Clipper2是由澳大利亚程序员Angus Johnson开发的一个高性能多边形裁剪和偏移库。它是原始Clipper库的全新重写版本，相比于10年前发布的Clipper1，Clipper2在算法效率、代码质量、功能完整性等方面都有了质的飞跃。该库原生支持C#语言，并可通过NuGet包管理器轻松安装（最新版本为2.0.0，新增三角化模块），使.NET开发者能够快速集成这个强大的几何运算工具。
