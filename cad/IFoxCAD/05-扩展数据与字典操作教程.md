...
<div style="display: flex; justify-content: space-between; margin: 20px 0;">
  <a href="04-选择集过滤器与图元选择教程" style="text-decoration: none;">← 上一章</a>
  <a href="./" style="text-decoration: none;">目录</a>
  <a href="06-扩展方法与实用工具教程" style="text-decoration: none;">下一章 →</a>
</div>
