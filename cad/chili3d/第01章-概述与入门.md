...
Chili3D是一款基于Web浏览器的开源3D CAD（计算机辅助设计）应用程序，专为在线模型设计和编辑而构建。该项目由开发者"仙阁"创建，采用TypeScript编写，通过将OpenCascade（OCCT）几何建模内核编译为WebAssembly，并与Three.js 3D渲染引擎集成，实现了接近原生应用程序的性能表现。最新版本为0.6.1（2026年），新增暗色主题、可调整侧边栏、改进的相机导航以及STEP/IGES/BREP格式导出支持。Chili3D的目标是让用户无需安装任何本地软件，即可在浏览器中完成强大的3D建模、编辑和渲染操作。
...
<div style="display: flex; justify-content: space-between; margin: 20px 0;">
  <span></span>
  <a href="https://znlgis.github.io/cad/chili3d/第01章-概述与入门/" style="text-decoration: none;">目录</a>
  <a href="https://znlgis.github.io/cad/chili3d/第01章-概述与入门/第02章-核心架构解析/" style="text-decoration: none;">下一章 →</a>
</div>
