...
- **跨平台支持**：充分利用.NET 10和Avalonia实现Linux/macOS支持
...
> **上一章**：[第十九章：调试测试与性能优化](https://znlgis.github.io/cad/LightCAD/第19章-调试测试与性能优化/)
>
> [返回教程目录](https://znlgis.github.io/cad/LightCAD/)
