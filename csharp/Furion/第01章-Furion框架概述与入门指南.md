...
| 2025年 | Furion 4.9.x | 支持.NET 9/10，稳定性持续增强 |
| 2026年8月 | Furion 4.9.9.92 | 全面支持.NET 10，最新稳定版本 |
| 预览版 | Furion 5.0.0 (Preview) | 面向下一代.NET的预览版本 |
...
**Furion 4.9.9.92（2026年8月，最新稳定版）**

- 全面支持.NET 10
- 最新的Source Generator优化和性能改进
- 增强的动态WebAPI和数据验证功能
- 改进的多租户和缓存机制

**Furion 5.0.0（Preview 预览版）**
...
| 技术 | 版本要求 | 用途 |
|------|---------|------|
| .NET SDK | 8.0 / 9.0 / 10.0+ | 运行时平台（最新版4.9.9.92支持.NET 10） |
