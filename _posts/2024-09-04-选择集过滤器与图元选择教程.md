...
<div style="display: flex; justify-content: space-between; margin: 20px 0;">
  <a href="03-SymbolTable符号表操作教程" style="text-decoration: none;">← 上一章</a>
  <a href="./" style="text-decoration: none;">目录</a>
  <a href="05-扩展数据与字典操作教程" style="text-decoration: none;">下一章 →</a>
</div>
