...
[← 上一章：空间分析与处理](第14章-空间分析与处理) | [返回目录](README) | [下一章：GeoServer集成开发 →](第16章-GeoServer集成开发)
...
<div style="display: flex; justify-content: space-between; margin: 20px 0;">
  <a href="第14章-空间分析与处理" style="text-decoration: none;">← 上一章</a>
  <a href="./" style="text-decoration: none;">目录</a>
  <a href="第16章-GeoServer集成开发" style="text-decoration: none;">下一章 →</a>
</div>
