...
**导航**
- 上一章: [第10章 - 约束求解器原理](第10章-约束求解器原理)
- 下一章: [第12章 - C语言库API详解](第12章-C语言库API详解)
...
<div style="display: flex; justify-content: space-between; margin: 20px 0;">
  <a href="第10章-约束求解器原理" style="text-decoration: none;">← 上一章</a>
  <a href="./" style="text-decoration: none;">目录</a>
  <a href="第12章-C语言库API详解" style="text-decoration: none;">下一章 →</a>
</div>
