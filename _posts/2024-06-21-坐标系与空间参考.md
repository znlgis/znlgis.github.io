...
[← 上一章：数据格式转换](第06章-数据格式转换) | [下一章：OGC 兼容开发 →](第08章-OGC兼容开发)
...
<div style="display: flex; justify-content: space-between; margin: 20px 0;">
  <a href="第06章-数据格式转换" style="text-decoration: none;">← 上一章</a>
  <a href="./" style="text-decoration: none;">目录</a>
  <a href="第08章-OGC兼容开发" style="text-decoration: none;">下一章 →</a>
</div>
