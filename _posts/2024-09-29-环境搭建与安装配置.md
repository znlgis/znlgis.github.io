...
**下一章预告**：[第03章 - DWG文件格式详解](第03章-DWG文件格式详解) - 深入了解DWG文件的内部结构和数据组织方式。
...
<div style="display: flex; justify-content: space-between; margin: 20px 0;">
  <a href="第01章-LibreDWG概述与入门" style="text-decoration: none;">← 上一章</a>
  <a href="./" style="text-decoration: none;">目录</a>
  <a href="第03章-DWG文件格式详解" style="text-decoration: none;">下一章 →</a>
</div>
